...
const PreviewMotionContext = createContext<MotionContextValue>({
  motionOff: false,
  reducedMotion: false,
  pointerFine: false,
});

export function PreviewMotionProvider({ children }: PropsWithChildren) {
  ...
  return (
    <PreviewMotionContext.Provider value={{ motionOff, reducedMotion, pointerFine }}>
...
export function Magnetic({ children, className }: MagneticProps) {
  const { reducedMotion, pointerFine } = usePreviewMotion();
